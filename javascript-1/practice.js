...
myNumbers.forEach(function(num, index, arr){
...
// Code Here
const forTheLoveOfGeorge = notGeorge.map(function(george, index, arr){
	return 'George'
})
//////////////////PROBLEM 19////////////////////
...
// Code Here
const enemies = people.filter(function(hito, index, arr){
	if(hito.friend === false){
		return hito
	}
})
//////////////////PROBLEM 20////////////////////
...
// Code Here
let totallyAwesome = people.reduce(function(acc, hito){
	return acc + hito.awesomeLevel
}, 0)
